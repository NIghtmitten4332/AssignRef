...
using Sabio.Models.Domain.TestAnswers;
using Stripe;
...
namespace Sabio.Services
{
    public class TestInstanceService : ITestInstancesService
    {
        ...
        {
            int id = 0;
            string procName = "[dbo].[TestInstances_InsertV3]";
         ...
         public TestInstanceGraded Update(TestInstanceUpdateRequest model, int userId)
        {
            TestInstanceGraded testGrade = null;
            string procName = "[dbo].[TestInstances_UpdateV2]";
            ...
            _data.ExecuteCmd(procName, delegate (SqlParameterCollection col)
            {
                ...
                int index = 0;
                testGrade = MapSingleGradedTest(reader, ref index);
            });
            return testGrade;
        }
     
        private TestInstanceGraded MapSingleGradedTest(IDataReader reader, ref int indx)
          {
              TestInstanceGraded graded = new TestInstanceGraded();
              graded.TotalQuestions = reader.GetSafeInt32(indx++);
              graded.EndTime = reader.GetSafeDateTime(indx++);
              graded.Correct = reader.GetSafeInt32(indx++);
              graded.Grade = reader.GetSafeDecimal(indx++);
              graded.Incorrect = reader.DeserializeObject<List<TestQuestionDetailed>>(indx++);
              return graded;
          }
        public Paged<TestInstanceAnswerCount> Search(int pageIndex, int pageSize, string query, DateTime startDate, DateTime endDate)
        {
            ...
            string procName = "[dbo].[TestInstances_SearchV2]";
        ...
        public Paged<BaseTestInstance> SelectAllInstances(int pageIndex, int pageSize)
        {
            ...
            string procName = "[dbo].[TestInstances_SelectAll]";
        ...
        public Paged<BaseTestInstance> SelectByTestId(int id, int pageIndex, int pageSize)
        {
            ...
            string procName = "[TestInstances_Select_ByTestId]";
        ...
        public Paged<BaseTestInstance> SelectByUserId(int userId, int pageIndex, int pageSize)
        {
            ...
            string procName = "[dbo].[TestInstances_Select_ByCreatedBy]";
        ...
        public TestInstanceDetailed SelectByInstanceIdDetailed(int id)
        {
            ...
            string procName = "[dbo].[TestInstances_Select_ByIdDetails]";
        ...
        {
            string procName = "[dbo].[TestInstances_Delete_ById]";
